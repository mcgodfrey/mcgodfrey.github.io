...
{% include image.html url="/img/2016/01/finished-product.jpg" description="The finished product after etching, painting and sanding back" %}
...
{% include image.html url="/img/2016/01/masks.png" description="Three masking techniques. (Top left) permanent “sharpie” marker, (top right) house paint, (bottom) paper mask with enamel spray paint (the paper was peeled off to expose the metal after the paint had dried)" %}
...
{% include image.html url="/img/2016/01/wires-attached.png" description="The piece is ready for etching with the wire taped to the backside" %}
...
{% include image.html url="/img/2016/01/solution-setup.png" description="Shows the etch bath setup with copper sulfate solution. On the right is the solution resistance (~400Ohms) measured with a multimeter and the probes ~10mm apart. This was the lowest resistance I could achieve which I assume means that the solution was saturated." %}
...
{% include image.html url="/img/2016/01/full-setup.png" description="This shows the full setup. On the left is the battery charger and multimeters to monitor the current and voltage. The right shows how the electrodes are positioned in the bath" %}
...
{% include image.html url="/img/2016/01/first-etch.jpg" description="After about 20 minutes of etching at 2.5A. Note the regions where the brass is showing through the green marker mask. This prompted a rethink and the new paint mask" %}
...
{% include image.html url="/img/2016/01/finished-etching.jpg" description="The two pieces after etching. The etch depth is about 0.1mm for both. Note that there is not a lot of contrast between the etched and unetched regions, and this became worse after a thorough clean" %}
