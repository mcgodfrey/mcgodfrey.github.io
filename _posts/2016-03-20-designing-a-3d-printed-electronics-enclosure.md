...
{% include image.html url="/img/2016/03/temp-logger-base-sketch-768x245.png" description="Sketch of the box and lid with standoffs, cutouts and interlocking lid." %}

{% include image.html url="/img/2016/03/temp-logger-base-extruded-768x247.png" description="Extrusion" %}
...
{% include image.html url="/img/2016/03/temp-logger-cutouts-768x174.png" description="Cutouts added to the walls for the SD card, temperature probes and DC input." %}
...
{% include image.html url="/img/2016/03/temp-logger-lid-cutouts-768x415.png" description="Cutouts added to the inside of the lid to recess the pushbuttons and LCD." %}

The final parts are then ready for printing!

{% include image.html url="/img/2016/03/temp-logger-final-box-300x188.png" description=" Final enclosure base " %}

{% include image.html url="/img/2016/03/temp-logger-final-lid-300x190.png" description=" Final enclosure lid " %}
...
{% include image.html url="/img/2016/03/img_20160320_1716181-768x503.jpg" description="The final printed enclosure" %}
